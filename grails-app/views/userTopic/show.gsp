        ...
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="topic" action="show"
                                                       id="${userTopicInstance?.topic?.id}">${userTopicInstance?.topic?.encodeAsHTML()}</g:link></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="user" action="show"
                                                       id="${userTopicInstance?.user?.id}">${userTopicInstance?.user?.encodeAsHTML()}</g:link></td>
