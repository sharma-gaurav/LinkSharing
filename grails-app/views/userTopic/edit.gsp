    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${userTopicInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userTopicInstance, field: 'topic', 'errors')}">
                                    <g:select name="topic.id" from="${com.intelligrape.linksharing.Topic.list()}" optionKey="id" value="${userTopicInstance?.topic?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userTopicInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.intelligrape.linksharing.User.list()}" optionKey="id" value="${userTopicInstance?.user?.id}"  />
                                </td>
                            </tr>
