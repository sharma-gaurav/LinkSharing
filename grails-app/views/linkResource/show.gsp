            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="linkResource.dateCreated.label" default="Date Created" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="topic" action="show" id="${linkResourceInstance?.topic?.id}">${linkResourceInstance?.topic?.name}</g:link></td>
