                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="heading" title="${message(code: 'linkResource.heading.label', default: 'Heading')}" />
                    ...
                    <g:each in="${linkResourceInstanceList}" status="i" var="linkResourceInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${linkResourceInstance.id}">${fieldValue(bean: linkResourceInstance, field: "id")}</g:link></td>
